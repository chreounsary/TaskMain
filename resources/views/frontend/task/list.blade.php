                 ...
                 @foreach ($tasks as $key => $task)
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="{{ route('module_create', ['project_id' => $task->project_id ,'task_id' => $task->id]) }}" class="btn btn-success btn-sm">
                        <i class="fas fa-plus"></i>
                      </a>
                      <a href="{{ route('task_show', ['id' => $task->id]) }}" class="btn btn-success btn-sm">
